...
psql_primary < "$PG_DIR/examples/models/demo/model.sql"
...
psql_primary < "$PG_DIR/examples/models/demo/seed.sql"
...
psql_accounting < "$PG_DIR/examples/models/demo/model.sql"
