...
--
-- pgauthzd connects as one service role and switches the per-request
-- identity with SET LOCAL ROLE (per-app namespace isolation). That updates
-- the 'role' GUC but not session_user — and inside SECURITY DEFINER
