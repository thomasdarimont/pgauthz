...
- **PostgREST v12.2.12** — Exposes SQL functions as REST API (read on port 3000, write on port 3001 behind Nginx)
- **OPA 1.4.2** — Rego policies for JWT authn and policy-as-code authz
